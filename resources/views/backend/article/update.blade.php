    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="box box-success">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{url('admin/articles/'.$selectArticle->id)}}" class="form-horizontal" method="post">
                    {{csrf_field()}}
                    {{method_field('put')}}
                    <div class="box-body">
                            ...
                            <div class="col-sm-11">
                                <select name="cate_id" class="form-control select2" style="width: 100%;">
                                    ...
                                    @foreach($categories as $category)
                                        <option value="{{$category->id}}" @if($category->id == $selectArticle->cate_id) selected @endif>{{str_repeat("|--",$category->level).$category->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <input type="text" readonly class="form-control" name="thumb" value="{{$selectArticle->thumb}}">
                                <input id="file_upload" class="" name="file_upload" type="file" multiple="true">
                                <img src="{{\App\Tools\Qiniu\QiniuHelper::showUrl($selectArticle->thumb)}}" alt="" id="art_thumb_img" style="max-width: 350px; max-height:100px;">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-11">
                                <textarea name="description" class="form-control" id="description" rows="3" placeholder="请输入描述">{{$selectArticle->description}}</textarea>
                            </div>
                        </div>
                        {{--<div class="form-group">--}}
                        ...
                        <div class="form-group">
                            <label for="keywords" class="col-sm-1 control-label">正文<label class="text-red">(必填)</label></label>
                            <div class="col-sm-11">
                                <textarea name="content" id="editor" style="height:1000px; width: 100%">{!!$selectArticle->content!!}</textarea>
                            </div>
                        </div>
